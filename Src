...
function EmocX:CreateWindow(title, opts)
    ...
    btnClose.MouseButton1Click:Connect(function()
        TweenService:Create(root, TweenInfo.new(0.18, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {BackgroundTransparency = 1, Size = UDim2.new(0,0,0,0)}):Play()
        task.delay(0.18, function() if sg and sg.Parent then sg:Destroy() end end)
    end)
